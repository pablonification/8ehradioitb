...
export default function UsersPage() {
  ...
  if (status === 'loading') {
    return <div className="p-8 text-center font-body">Loading session...</div>;
  }
  ...
  return (
    <div className="p-8">
      ...
      {loading && <p className="font-body">Loading users...</p>}
        ...
        <div className="bg-white shadow-md rounded-lg overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider font-body">Name</th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider font-body">Email</th>
