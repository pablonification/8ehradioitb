...
/**
 * TrainingStudio Component
 *
 * Feature 2: Model Training Studio
 * Assigned to: Dhika
 *
 * API Endpoints:
 * - GET /api/ml/generate-dummy (get scenarios & generate data)
 * - POST /api/ml/generate-dummy (generate dummy data)
...
export default function TrainingStudio() {
  ...
  // Reset generated data when scenario changes
  useEffect(() => {
        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
          <h3 className="text-lg font-heading font-semibold text-gray-800 mb-3">
            ...
            <span className="text-sm font-normal text-gray-500 ml-2">
              (showing 5 of {generatedData.sample_size} rows)
            </span>
          </h3>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              {trainingStatus.success ? (
                <div className="mt-2 space-y-1 text-sm font-body text-green-700">
                  <p>
                    <strong>Model ID:</strong> {trainingStatus.id}
                  </p>
                  <p>
                    <strong>Status:</strong> {trainingStatus.status}
                  </p>
                  <p className="text-green-600 mt-2">
                    Check the "Model Status" tab to monitor training progress.
                  </p>
                </div>
              ) : (
