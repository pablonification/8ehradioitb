...
const photoPaths: Record<string, string> = {
  "Cindy Juanita KI'23": '/foto-mb/General Manager/General Manager_Cindy Juanita W.JPG',
  "Michelle Angelica BI'23": '/foto-mb/Human & Resource Development/HRD Director_Chellee.png',
  "Kevin Azra II'23":
  ...
  "Fardan Naufal SA'23": '/foto-mb/Human & Resource Development/People Management.JPG',
  "Nandita Mahyas AR'23":
    '/foto-mb/Human & Resource Development/Peope and Culture Manager_Nandita Mahyas A_.jpg',
  "Danella Nafisya MR'23": '/foto-mb/General Secretary/General Secretary_Danella Nafisya.png',
  "Qoulan Tsaqila SI'23": '/foto-mb/General Secretary/HNA_Qoulan Tsaqila.jpg',
  "Fahlianti Afif PL'23": '/foto-mb/General Secretary/Vice HNA_Fahlianti Afif.png',
  "Kayla Adina MB'26": '/foto-mb/General Secretary/Finance Manager.JPG',
  "Aliyah Zidna GD'23": '/foto-mb/General Secretary/Vice Finance_Aliyah Zidna Latifanisa.jpg',
  "Keisha Amalia MB'23": '/foto-mb/Research & Development/Research & Development Director.jpg',
  "Rachael Immanuel MB'23":
    '/foto-mb/Research & Development/Vice Research & Development Director.jpg',
  "Aisya Cendekia MR'23": '/foto-mb/Public Relation/PR Director_Aisya Cendekia Putri.jpeg',
  "Adisha Oktaviani BP'23":
    '/foto-mb/Public Relation/Intracampus Manager_Adisha Oktaviani Ramadhan.jpg',
  "Virassiska Yuliana PG'23": '/foto-mb/Public Relation/Extracampus Manager_Virasiska Yuliana.jpg',
  "Marsa Faustina KL'23": '/foto-mb/Public Relation/Vice Extrcampus Manager_Marsa Faustina.jpg',
  "Marcella Stely DKV'23": '/foto-mb/Public Relation/Manager Partnership_Marcella Stely Lukas.jpeg',
  "Grace Natalie BI'23":
  ...
  "Maria Anabel MB'26": '/foto-mb/Brand Awareness/Creative Marketing Manager_Maria Anabel.jpg',
  ...
  "Raissa Azra BA'23": '/foto-mb/Brand Awareness/Vice Content Strategy_Raissa Azra Luthfiyah_.jpg',
  "Muhammad Raga TF'23":
  ...
  "Shobiha Shiam KI'23": '/foto-mb/On-Air Operations/On-Air Operations Director.jpg',
  "Happy Sri DKV'23":
  ...
  "Tamima Meirizqeena KI'23": '/foto-mb/On-Air Operations/Announcer Manager_Tamima Meirizqeena.JPG',
  "Valerie Chelsea FA'23": '/foto-mb/On-Air Operations/Music Manager_Valerie Chelsea Wijaya.jpg',
...
type BoardNode = {
  ...
  ig?: string
  linkedin?: string
  subordinates?: Record<string, BoardNode>
  [key: string]: unknown
}

function getMembers(data: Record<string, BoardNode>) {
  const members: BoardMember[] = []

  function traverse(node: BoardNode, role: string) {
    if (node.name) {
      members.push({
        name: node.name,
        role: role,
    ...
    for (const key in node) {
      ...
      if (key.startsWith('Vice ') && typeof nodeValue === 'object' && nodeValue !== null) {
        traverse(nodeValue as BoardNode, key)
      }
    }
  }

  const rootRole = Object.keys(data)[0]
  const rootNode = data[rootRole]
  if (rootNode) {
    traverse(rootNode, rootRole)
  }
  return members
}
        ...
        {members.map((member, idx) => (
          <SwiperSlide key={idx} className="pb-8">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="flex h-36 w-36 items-center justify-center overflow-hidden rounded-lg bg-gray-200">
                <Image
                  src={member.photoUrl}
