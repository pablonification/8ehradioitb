...
export default function DashboardSidebar() {
  ...
  return (
    <aside
      className={`h-full flex flex-col bg-white shadow-lg transition-all duration-300 ease-in-out ${isExpanded ? "w-64" : "w-20"}`}
    >
      <div
        className={`flex items-center p-4 border-b border-gray-200 ${isExpanded ? "justify-between" : "justify-center"}`}
      >
        {isExpanded && (
          <Link href="/dashboard">
            <Image
