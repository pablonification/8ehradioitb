...
type RateCardTerm = 'shortTerm' | 'longTerm'
...
type RateCardData = Record<RateCardTerm, PricingPlan[]>
...
const rateCardData: RateCardData = {
  shortTerm: [
    {
      title: 'Paket Pop',
      price: 'FREE!',
...
const CheckmarkIcon = () => (
  <svg
    className="mt-1 mr-3 h-4 w-4 flex-shrink-0 text-black"
...
const MedpartHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-yellow-200 pt-48 pb-0">
      ...
      <Image
        ...
        width={600}
        height={600}
        className="pointer-events-none absolute top-[5%] left-0 z-0 w-30 select-none md:top-[20%] md:left-1/2 md:w-80 md:-translate-x-[220%]"
        priority
      />
      <Image
        ...
        width={600}
        height={600}
        className="pointer-events-none absolute top-0 right-0 z-0 w-60 translate-x-[30%] select-none md:right-1/2 md:w-120 md:translate-x-[160%]"
        priority
      />

      {/* Kontainer Konten Utama */}
      <div className="relative z-10 mx-auto flex max-w-7xl items-center px-4 sm:px-6 lg:px-24">
        {/* Sisi Kiri: Teks & Tombol */}
        <div className="mb-12 w-full text-start md:mb-0">
          <h1 className="font-accent mb-6 text-6xl font-medium text-gray-800 md:text-8xl">
            Partner with Us
          </h1>
          <p className="mx-auto mb-8 text-lg text-gray-700 md:mx-0">
            Temukan peluang baru dengan berkolaborasi bersama 8EH Radio ITB melalui media
            partnership!
          </p>
        </div>
      </div>
      ...
      <div className="relative -mt-80 mb-30 flex justify-center md:-mt-90 md:mb-0">
        <Image
          src="/vstock-medpart-1.png"
          alt="Radio Illustration"
          width={1440}
          height={700}
          className="pointer-events-none w-full max-w-[1920] [mask-image:linear-gradient(to_bottom,red_60%,orange_100%)] mix-blend-hard-light select-none"
          priority
        />
      </div>
    </section>
...
const OfferedService = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-yellow-200 to-white pt-40">
      <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="font-accent text-6xl text-black">Offered Services</h1>
        </div>
        <div className="justify-content-center mx-auto grid grid-cols-1 gap-x-12 gap-y-6 md:grid-cols-2 lg:w-full">
          <div className="mb-4 grid items-center gap-8 rounded-4xl border border-gray-200/80 bg-gradient-to-br from-orange-600/80 via-yellow-500/50 to-yellow-100/30 px-10 py-6 backdrop-blur-xs transition-all duration-300 hover:border-gray-300 md:grid-cols-1 md:px-16 md:shadow-xl">
            <div className="justify-content-center mx-auto grid grid-cols-1 gap-x-12 gap-y-6 lg:w-full">
              ...
              <div className="grid grid-cols-6 items-start space-x-4">
                ...
                />
                <div className="col-span-5 self-center">
                  <h3 className="font-body text-lg font-semibold text-black">Live Report</h3>
                  <p className="font-body text-sm text-black">
          ...
          <div className="mb-4 grid items-center gap-8 rounded-4xl border border-gray-200/80 bg-gradient-to-br from-orange-600/80 via-yellow-500/50 to-yellow-100/30 px-10 py-6 backdrop-blur-xs transition-all duration-300 hover:border-gray-300 md:grid-cols-1 md:px-16 md:shadow-xl">
            <div className="justify-content-center mx-auto grid grid-cols-1 gap-x-12 gap-y-6 lg:w-full">
              <div className="grid grid-cols-6 items-start space-x-4">
                ...
                />
                <div className="col-span-5 self-center">
                  <h3 className="font-body text-lg font-semibold text-black">Artikel / Iklan</h3>
                  <p className="font-body text-sm text-black">
              ...
              <div className="grid grid-cols-6 items-start space-x-4">
                ...
                />
                <div className="col-span-5 self-center">
                  <h3 className="font-body text-lg font-semibold text-black">Infografis</h3>
                  <p className="font-body text-sm text-black">Konten visual post-event di IG</p>
                </div>
              </div>
            </div>
          </div>
...
export function RateCard() {
  const [activeTerm, setActiveTerm] = useState<RateCardTerm>('shortTerm')
  const currentPlans = rateCardData[activeTerm]

  return (
    <section className="relative mt-12 bg-slate-100 px-4 py-20">
      <div className="absolute top-10 left-0 w-30 opacity-80 md:left-1/2 md:w-90 md:-translate-x-[100%]">
        <Image src="/vstock-medpart-2.png" alt="decoration" width={150} height={150} />
      </div>
      <div className="absolute top-10 right-0 w-30 opacity-80 md:right-1/2 md:w-90 md:translate-x-[160%]">
        <Image src="/vstock-medpart-3.png" alt="decoration" width={150} height={150} />
      </div>

      <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <p className="font-body font-bold text-gray-800">Media Partner</p>
        <h2 className="font-accent mb-2 text-7xl font-bold text-gray-900">Rate Card</h2>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-12 flex justify-center">
          <div className="relative flex w-72 items-center rounded-full bg-gray-200 p-1">
            ...
            <div
              className={`absolute h-[calc(100%-8px)] w-1/2 rounded-full bg-white shadow-md transition-transform duration-300 ease-in-out ${activeTerm === 'shortTerm' ? 'translate-x-0' : 'translate-x-[calc(100%-8px)]'}`}
            />

            {/* Tombol Teks (di atas latar belakang) */}
            <button
              onClick={() => setActiveTerm('shortTerm')}
              className={`relative z-10 w-1/2 cursor-pointer py-2 text-center text-sm font-semibold transition-colors duration-300 ${
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {currentPlans.map((plan: PricingPlan, index: number) => (
            <div
              key={index}
              className={`flex transform flex-col rounded-4xl border border-gray-300 bg-gradient-to-br p-8 text-black shadow-md backdrop-blur-md transition-transform duration-300 hover:scale-101 ${plan.gradient} max-w-xs`} // max-w-xs digunakan untuk lebar maksimal 20rem (320px)
            >
              <h3 className="font-heading mb-2 text-center text-2xl">{plan.title}</h3>
              <p className="font-heading mb-6 text-center text-5xl font-semibold">{plan.price}</p>
              ...
              <ButtonPrimary
                className="!bg-[#EA4A30] !px-8 !py-2 !text-white hover:!bg-[#D0402A]"
                onClick={() => {
...
const ProsedurSection = () => {
  const [activeSection, setActiveSection] = useState<string>('terms-and-conditions')
  ...
  return (
    <section className="relative overflow-clip bg-gradient-to-b from-white to-gray-400 px-4 py-20 sm:px-6 lg:px-8">
      {/* Gambar Dekoratif */}
      <Image
        ...
        width={100}
        height={100}
        className="absolute top-1/2 left-5 w-30 -rotate-12 opacity-100"
      />
      <Image
        ...
        width={300}
        height={300}
        className="absolute bottom-4 left-1/2 z-0 w-40 rotate-12 opacity-100"
      />
      <Image
        ...
        width={300}
        height={300}
        className="absolute top-0 right-0 z-0 w-40 rotate-12 opacity-100"
      />

      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-4">
        {/* Kolom Kiri: Daftar Isi (Table of Contents) */}
        <aside className="lg:col-span-1">
          <div className="sticky top-24 rounded-2xl bg-gray-300/60 text-black shadow-lg backdrop-blur-sm">
              ...
              {procedureData.map((item) => (
                <li key={item.id}>
                  ...
                  <button
                    ...
                    className={`w-full cursor-pointer rounded-4xl px-4 py-2 text-left text-sm transition-all duration-300 ${item.type === 'sub' ? 'pl-8' : ''} ${
        ...
        <main className="lg:col-span-3">
          <div className="relative z-20 rounded-4xl bg-white/50 p-8 shadow-lg backdrop-blur-sm sm:p-12">
            <div className="space-y-12">
              ...
              {procedureData
                ...
                .map((section) => (
                  ...
                  >
                    <h2
                      className={` ${section.type === 'main' ? 'border-orange-500 text-4xl' : 'border-orange-400 text-3xl'} font-heading mb-4 border-l-4 pl-4 font-bold text-gray-800`}
                    >
                      {section.title}
                    </h2>
                    <ol className="font-body list-inside list-decimal space-y-3 leading-relaxed text-gray-700">
...
const PartnerMarquee = () => {
  ...
  return (
    <section className="px-4 py-12 md:px-12 lg:px-24">
      ...
      */}
      <div className="flex w-full flex-col items-center overflow-hidden rounded-3xl bg-gradient-to-r from-orange-500 to-yellow-400 shadow-lg md:h-24 md:flex-row">
        {/* 2. Bagian Teks Statis:
          - Padding dan perataan teks diatur untuk mobile dan desktop
        */}
        <div className="flex-shrink-0 p-6 text-center md:w-1/4 md:p-8 md:text-left">
          <p className="text-sm font-semibold text-black">
            8EH Radio ITB telah menjalin kolaborasi dengan berbagai institusi dan mitra
          </p>
        </div>
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-yellow-100 to-orange-200 py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="font-body mb-16 text-gray-600">
          Kami ingin mendengar kabar darimu! Hubungi kami untuk pertanyaan, saran, atau kolaborasi
          lebih lanjut.
        </p>
...
export default function MediaPartnerPage() {
  return (
    <main className="font-body bg-[#FEFBF8]">
      <Navbar />
      <MedpartHero />
      <OfferedService />
      <RateCard />
